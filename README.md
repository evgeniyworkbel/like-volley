...
### Работа с пакетами
1. Установка любых пакетов заранее обсуждается и согласуется.

Принцип: чем меньше пакетов будет в зависимостях, тем лучше

2. При установке пакетов ставить самые строгие версии
3. При апгрейде пакетов всегда самому читать CHANGELOG файлы на гитхабе к этим пакетам
4. При апгрейде пакетов всегда строго следовать инструкциям по миграции, указанным в документации к пакетам (обычно на сайте указаны)
5. Не использовать ИИ для миграции на новые версии, делать самому
