export default function Policy() {
  return (
    <article>
      ...
      <section className="flex flex-col items-center p-5 text-sm">
        <ol className="xl:max-w-[860px]">
          <li>
            1. Общие положения Настоящая политика обработки персональных данных составлена
            ...
            предпринимаемые И П Судариков Никита Юрьевич (далее — Оператор).
          </li>
          <li>
          ...
          <li className="pb-4">
            ...
            веб-сайта
            <span className="text-accent-orange">&nbsp;https://culturagraphica.ru.</span>
          </li>
