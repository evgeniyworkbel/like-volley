...
export function SharePost({ className, url }: SharePostProps) {
  ...
  return (
    ...
    >
      <FacebookShareButton url={href} aria-label="Поделиться этой ссылкой в Facebook">
        <FacebookIcon size={24} round />
      </FacebookShareButton>
      <TelegramShareButton url={href} aria-label="Поделиться этой ссылкой в Telegram">
        <TelegramIcon size={24} round />
      </TelegramShareButton>
      <VKShareButton url={href} aria-label="Поделиться этой ссылкой в ВКонтакте">
        <VKIcon size={24} round />
      </VKShareButton>
      <OKShareButton url={href} aria-label="Поделиться этой ссылкой в Одноклассники">
        <OKIcon size={24} round />
      </OKShareButton>
      <ThreadsShareButton url={href} aria-label="Поделиться этой ссылкой в Threads">
