    ...
    <div className="flex flex-col gap-5">
      {items.map(({ question, answer }) => {
        return (
          <div
            key={question}
            className="group mb-2 cursor-pointer list-none items-center justify-between rounded-xl border border-accent-orange-light p-6 text-sm font-semibold hover:border-accent-orange xl:text-lg"
          >
