...
export function Hero() {
  return (
    <section className="relative flex overflow-hidden px-5 pt-5 pb-12.5 text-center text-black md:pt-12.5 xl:justify-between xl:px-20">
      <div className="flex rounded-[20px] p-5 md:py-9 md:pr-0 md:pl-9 xl:items-start">
      ...
      <div className="absolute top-0 right-0 flex origin-top-right rotate-[16.8deg] xl:h-175 xl:w-100">
        <div className="flex flex-col gap-4">
          <Image
            className="animate-to-top"
