...
export function Banner() {
  return (
    <section className="flex justify-center px-5 py-[50px] xl:px-20">
      <div className="relative flex aspect-[0.7] w-full justify-center rounded-2xl border-4 border-[oklch(0.6559_0.1604_257.81)] bg-accent-blue px-5 pt-4 xl:aspect-[4.3] xl:h-[297px] xl:items-center xl:justify-start xl:pt-0 xl:pl-10">
