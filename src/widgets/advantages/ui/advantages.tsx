...
export function Advantages() {
  return (
    <section className="flex max-w-360 flex-col items-center gap-12 px-10 py-[74px] text-center text-sm xl:flex-row xl:justify-between xl:gap-0 xl:px-20 xl:text-base">
